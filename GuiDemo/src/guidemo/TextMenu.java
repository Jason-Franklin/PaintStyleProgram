...
private final DrawPanel panel; // the panel whose text is controlled by this
// menu

private JCheckBoxMenuItem bold; // controls whether the text is bold or not.
private JCheckBoxMenuItem italic; // controls whether the text is italic or
// not.
...
// method called makeJustifyMenu() this contains a menu which contains three JRadioButtonMenuItem and are added

// to the ButtonGroup, add action listeners are added to these three JRadioButtonMenuItem radio buttons.

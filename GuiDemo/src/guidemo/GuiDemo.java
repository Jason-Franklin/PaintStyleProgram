...
private JCheckBoxMenuItem gradientOverlayCheckbox = new JCheckBoxMenuItem(
...
super("Sayings"); // Specifies the string for the title bar of the
// window.
...
.setText("Big bugs have little bugs "
...
// Create the menu bar and add it to the frame. The TextMenu is defined
// by
...
// Create and customize the file chooser that is used for file
// operations.

fileChooser = new SimpleFileChooser();
try
{ // I'd like to use the Desktop folder as the initial folder in the
// file chooser.
...
// JToolBar method that add the background tools and save and new pictures icons with action listeners
...
true ? JToolBar.HORIZONTAL : JToolBar.VERTICAL);
...
public void actionPerformed(ActionEvent evt)
{
File f = fileChooser.getOutputFile(drawPanel, "Select Ouput File",
"saying.jpeg");
if (f != null)
{
try
...
{
Color c = JColorChooser.showDialog(drawPanel,
